...
module.exports = {
  ...
  db: process.env.MONGODB || process.env.MONGOLAB_URI || 'mongodb://localhost:27017/adc',
  ...
  github: {
    clientID: process.env.GITHUB_ID || 'ab593a9b1a9748d81b71',
    clientSecret: process.env.GITHUB_SECRET || 'c90d0f864d7a36704f188f763b54d02b8d2eb474',
